...
public class InfluxDBServiceImpl implements InfluxDBService {
	...
	public void write(String data) {
		DataPoint dataPoint = JSON.parseObject(data, DataPoint.class);
		Point point = Point.measurementByPOJO(DataPoint.class)
				.addFieldsFromPOJO(dataPoint)
				.time(dataPoint.getSourceTime(), TimeUnit.MILLISECONDS)
				.build();
		influxDBTemplate.write(point);
	}
